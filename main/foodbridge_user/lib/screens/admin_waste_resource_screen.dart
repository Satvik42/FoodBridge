...
class AdminWasteResourceScreen extends StatefulWidget {
  const AdminWasteResourceScreen({super.key});
  @override
  State<AdminWasteResourceScreen> createState() => _AdminWasteResourceScreenState();
}

class _AdminWasteResourceScreenState extends State<AdminWasteResourceScreen> {
